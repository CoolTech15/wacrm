    ...
    return (
      <Card className="w-full max-w-md border-slate-200 bg-white shadow-md rounded-xl">
        <CardHeader className="items-center text-center">
          ...
          <CardTitle className="text-xl text-slate-900 font-bold">{copy.title}</CardTitle>
          ...
          {peek.reason === 'server_error' ? (
            <>
              <Button
                ...
                className="w-full bg-primary hover:bg-primary-hover text-white font-medium shadow-xs"
              >
                Try again
              </Button>
              <Link href="/signup">
            ...
            <>
              <Link href="/signup">
                <Button className="w-full bg-primary hover:bg-primary-hover text-white font-medium shadow-xs">
                  Create a new account instead
                </Button>
              </Link>
              <Link href="/login">
        ...
        <Card className="w-full max-w-md border-slate-200 bg-white shadow-md rounded-xl">
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <p className="text-center text-xs text-slate-500">
              ...
              <span className="text-slate-700 font-medium">{peek.account_name}</span>. Your
        ...
        >
          <DialogContent className="bg-white border-slate-200 sm:max-w-md text-slate-900">
            ...
            <div className="space-y-2 py-2 text-xs text-slate-500">
              <p>
                To join{' '}
                <span className="text-slate-700 font-medium">{peek.account_name}</span>,
