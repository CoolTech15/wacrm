...
function StageColumn({
  ...
  return (
    ...
    <div className="flex w-[85vw] min-w-[260px] max-w-[320px] shrink-0 snap-start flex-col rounded-xl border border-slate-200/60 bg-slate-50/80 p-4 lg:w-auto lg:max-w-none lg:flex-1 lg:basis-[260px] lg:shrink lg:snap-none">
      ...
      <div className="flex items-center justify-between pt-3">
        ...
        <span className="shrink-0 rounded-full bg-slate-200/60 px-2 py-0.5 text-[11px] font-semibold text-slate-700">
          {deals.length}
        </span>
      </div>
      ...
      >
        {deals.length === 0 ? (
          <div className="flex flex-1 items-center justify-center rounded-lg border-2 border-dashed border-slate-200 bg-white/40 py-10 text-xs text-slate-400">
            Drop a deal here
          </div>
        ) : (
          deals.map((deal) => (
      ...
      <Button
        ...
        className="mt-3 w-full justify-start border border-dashed border-slate-200 bg-white text-slate-600 hover:border-slate-300 hover:bg-slate-50 hover:text-slate-900 shadow-xs"
      >
